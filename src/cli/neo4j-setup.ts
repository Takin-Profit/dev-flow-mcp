...
export type ConnectionManagerFactory = (
  config: Neo4jConfig
...
const defaultSchemaManagerFactory: SchemaManagerFactory = (
  connectionManager,
  debug
...
export async function initializeSchema(
  ...
  try {
    ...
    if (recreate) {
      console.log(
        "Using recreate mode: will drop and recreate constraints and indexes"
      )
    }
